...
# Version
VERSION="2.0"
OPSN_CONTAINERS="opsn-dvwa opsn-juice-shop opsn-gophish opsn-desktop opsn-dns-server opsn-mailserver"
...
services:
    ...
    opsn-desktop:
        ...
        restart: unless-stopped
    opsn-dns-server:
        container_name: opsn-dns-server
        hostname: opsn-dns-server
    ...
    opsn-mailserver:
        ...
        container_name: opsn-mailserver
